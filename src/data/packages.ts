...
export const games = [
  ...
  },
  {
    ...
    icon: "/images/clash-royal-icon.png",
    productIconClass: "w-25 h-25",
    description: "Карточки, сундуки, пасы",
    tag: "Топ продаж",
    banner: "/images/clash-banner.jpg",
  ...
  },
  {
    ...
    icon: "/images/fortnite-lama-icon.png",
    description: "Скины, эмоции, боевой пропуск",
    tag: "Хит",
    banner: "/images/fortnite-banner.png",
  ...
  },
  {
    ...
    icon: "/images/apex-legends-icon.png",
    productIconClass: "w-30 h-30",
