...
import { fetchPackagesByGame, fetchGames, type GameApi, type PackageApi } from "../../api/games";
...
export const Products = forwardRef<HTMLElement, ProductsProps>(
  function Products({ selectedGame }, ref) {
    ...
    useEffect(() => {
      ...
      fetchPackagesByGame(selectedGame).then(setPackages);
    }, [selectedGame]);

    function handleAdd(pkg: PackageApi) {
      setAddedIds((prev) => new Set([...prev, pkg.id]));
      addItem(pkg as unknown as Package);
      setTimeout(() => {
        setAddedIds((prev) => {
                ...
                {!game ? (
                  ...
                  <div>
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-12">
                      ...
                      <div
                        className="sm:ml-auto flex items-center gap-2 text-xs text-white/40 px-3 py-2 rounded-xl"
                        style={{
